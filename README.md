...
- [VKArchiveDownloader](#vkarchivedownloader)
  ...
  - [4. Вопросы и ответы](#4-вопросы-и-ответы)
    ...
    - [4.4 Почему в фото профиля поддерживаются, а лайкнутые фото - нет?](#44-почему-в-фото-профиля-поддерживаются-а-лайкнутые-фото---нет)
...
### 4.4 Почему в фото профиля поддерживаются, а лайкнутые фото - нет?
