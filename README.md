...
- Ссылки 1 категории - либо ссылки на какой-либо документ, либо ссылка на фото с предпросмотром в интерфейсе [VKontakte](https://vk.com/feed)
  (с лайками, комментариями и так далее).
...
| ЦП или SoC                                                                                                                        |   🍪   | ОС                                                         | Кол-во 🔗 в `Сообщения` | Кол-во 🔗 в `👍->Фото` | Кол-во 🔗 в `Фотографии` | Кол-во 🔗 в `Файлы` |   ⌛ поиска 🔗   |  ⌛ скачивания  |     ⌛ время     |
| --------------------------------------------------------------------------------------------------------------------------------- | :---: | ---------------------------------------------------------- | :--------------------: | :------------------: | :---------------------: | :----------------: | :------------: | :------------: | :-------------: |
| [i7-8565U](https://ark.intel.com/content/www/us/en/ark/products/149091/intel-core-i78565u-processor-8m-cache-up-to-4-60-ghz.html) |   ✅   | Windows 11                                                 |         13753          |         239          |            1            |        1148        | 2 мин. 1 сек.  | 8 мин. 10 сек. | 10 мин. 11 сек. |
