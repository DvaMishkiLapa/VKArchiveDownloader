...
- [VKArchiveDownloader ](#vkarchivedownloader-)
  ...
  - [4. Вопросы и ответы](#4-вопросы-и-ответы)
    ...
    - [4.8 Чем опасно отключение проверки SSL сертификата? (флаг `disable_ssl`)](#48-чем-опасно-отключение-проверки-ssl-сертификата-флаг-disable_ssl)
...
### 4.8 Чем опасно отключение проверки SSL сертификата? (флаг `disable_ssl`)
